...
//    }
    ...
    public void setParam(double vx, double vy, double slope)
    {
        this.vx = vx;
        this.vy = vy;
        this.slope = slope;
...
//        }
    ...
    public double f(double vx, double vy, double dx)
    {
        double f = - mass*g*slope - -friction*mass*g*(vy/(Math.sqrt((vx*vx)+(vy*vy) + 0.000001))) ;
        return f;
    }
