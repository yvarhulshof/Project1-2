...
public class DerivativeCalculator {
    ...
    static String equation = "3x^2+16sinx";
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Integer> allNumbers = findNumbers(equation);
        ...
        ArrayList<Character> allLetters = findLetters(equation);
     ...
     *****************************************************************************************************************************
     */
    public static int findPow(String substring) {
        for (int i = 0; i < substring.length(); i++) {
            if (substring.charAt(i) == 94) {
                ArrayList<Integer> numbers = findNumbers(substring.substring( i,substring.length()));
    ...
    public static ArrayList<Integer> findNumbers(String eqPart) {
        ...
        for (int i = 0; i < eqPart.length(); i++) {
            if (eqPart.charAt(i) > 46 && eqPart.charAt(i) < 59) {
                search = true;
        ...
        //numbers.add(Integer.parseInt(strNumbers)); empty anyway
     ...
     **************************************************************************************************************************************************
     */
    public static ArrayList<Character> findLetters(String substring) {
        ...
        //letters.add(Integer.parseInt(number.toString()));
        return letters;
    }
    ...
    public static ArrayList<String> powerDerivation( String firstCoeff) {
        ...
        ArrayList<String> powerDerived = new ArrayList<>();
